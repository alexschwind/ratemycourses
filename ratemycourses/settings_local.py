...
WSGI_APPLICATION = 'ratemycourses.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': config('POSTGRES_DB', default='ratemycourses'),
...
# LOCAL DEVELOPMENT SECURITY SETTINGS (less strict than production)
...
# LOCAL DEVELOPMENT: Disable SSL/HTTPS requirements
...
# ANYMAIL - Use console backend for local development
ANYMAIL = {
